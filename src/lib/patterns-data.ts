...
export const mockArchitectures: Architecture[] = [
  ...
  },
  {
    ...
    name: "MVC",
    slug: "mvc",
    description: "Separa la aplicación en Model, View y Controller para mejor organización.",
    icon: "layout-grid",
  ...
  },
  {
    ...
    name: "MVVM",
    slug: "mvvm",
    description: "Patrón arquitectónico que facilita el binding bidireccional entre vista y datos.",
    icon: "layers-3",
