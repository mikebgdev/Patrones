        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <div className="flex items-start gap-6 mb-6">
              <div
                className={`w-20 h-20 bg-gradient-to-br ${pattern.color} rounded-xl flex items-center justify-center flex-shrink-0`}
              >
                {(() => {
            ...
            <div className="space-y-6">
                ...
                <CardContent>
                  <div className="space-y-2">
                    {pattern.relatedPatterns.map((relatedSlug: string) => {
                      const relatedPattern = allPatterns.find(
                        (p) => p.slug === relatedSlug,
                      );
                      return relatedPattern ? (
                        <Link
                          key={relatedSlug}
                          href={`/pattern/${relatedSlug}`}
                        >
                          <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                            <div
                              className={`w-8 h-8 bg-gradient-to-br ${relatedPattern.color} rounded-lg flex items-center justify-center`}
                            >
                              {(() => {
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  >
                    <a
                      href={`https://refactoring.guru/es/design-patterns/${pattern.slug}`}
                      target="_blank"
